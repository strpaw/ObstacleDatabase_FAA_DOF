...
class DOFConverter:
    ...
    def get_fields():
        ...
        fields.append(QgsField("verif_status_code", QVariant.String))
        ...
        fields.append(QgsField("agl", QVariant.String))
        fields.append(QgsField("amsl", QVariant.String))
        fields.append(QgsField("lighting_code", QVariant.String))
        fields.append(QgsField("hor_acc_code", QVariant.String))
        fields.append(QgsField("vert_acc_code", QVariant.String))
        fields.append(QgsField("marking_code", QVariant.String))
